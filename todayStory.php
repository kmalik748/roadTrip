...
$sql = "SELECT
        id, title, latitude, longitude, marker_radius, amazon_polly_audio_link_location as audio, opening_sound, closing_sound, categories,
        country, image, region, story_type, eventdate
        FROM wp_audio_info
        WHERE post_status='publish' AND  story_type = '$type' AND DAY(eventdate) = $day AND MONTH(eventdate) = $month
        LIMIT 0 , 20";
